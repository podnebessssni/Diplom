...
public class DataHelper {
    ...
    static int monthNumber = 1 + random.nextInt(9 - 1);
    static String wrongMonthNumber = Integer.toString(monthNumber);
    ...
    public static CardInformation getInvalidCardInformation() {
        return new CardInformation("4444 4444 4444 4443", "22", "11", faker.name().fullName(), correctCVC);
    }
